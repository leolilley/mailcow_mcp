...
export class OAuth2API {
   ...
   */
  async listOAuth2Clients(params?: ListOAuth2Params): Promise<MailcowOAuth2Client[]> {
    const response = await this.client.get<MailcowOAuth2Client[]>(
      buildOAuth2Endpoint('list'),
      { params }
    );
    return response;
  }
   ...
   */
  async createOAuth2Client(clientData: CreateOAuth2Request): Promise<MailcowOAuth2Client> {
    const response = await this.client.post<MailcowOAuth2Client>(
      buildOAuth2Endpoint('create'),
      clientData
    );
    return response;
  }
   ...
   */
  async updateOAuth2Client(clientId: string, clientData: UpdateOAuth2Request): Promise<MailcowOAuth2Client> {
    const response = await this.client.post<MailcowOAuth2Client>(
      buildOAuth2Endpoint('update'),
   ...
   */
  async updateOAuth2ClientName(clientId: string, name: string): Promise<MailcowOAuth2Client> {
   ...
   */
  async updateOAuth2ClientDescription(clientId: string, description: string): Promise<MailcowOAuth2Client> {
   ...
   */
  async updateOAuth2ClientRedirectURIs(clientId: string, redirectUris: string[]): Promise<MailcowOAuth2Client> {
   ...
   */
  async updateOAuth2ClientScopes(clientId: string, scopes: string[]): Promise<MailcowOAuth2Client> {
   ...
   */
  async getOAuth2ClientsCreatedAfter(date: Date): Promise<MailcowOAuth2Client[]> {
   ...
   */
  async getOAuth2ClientsCreatedBefore(date: Date): Promise<MailcowOAuth2Client[]> {
   ...
   */
  hasRequiredScopes(client: MailcowOAuth2Client, requiredScopes: string[]): boolean {
   ...
   */
  async getOAuth2ClientByRedirectURI(redirectUri: string): Promise<MailcowOAuth2Client | null> {
